$(function() {
  function tabStyleChenge(block, none) {
    $('#keyword-class-' + block).css("color", "#4277FB");
    $('#keyword-class-' + block).css("border-bottom", "2px solid #4277FB");
    $('#keyword-class-' + block).css("font-weight", "bold");
    $('#keyword-class-' + none).css("color", "#999");
    $('#keyword-class-' + none).css("border-bottom", "2px solid #fff");
    $('#keyword-class-' + none).css("font-weight", "normal");
  }
  $('#keyword-class-news').on('click', function() {
    tabStyleChenge('news', 'comment');
